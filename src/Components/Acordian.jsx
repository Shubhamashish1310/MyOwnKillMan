...
function Accordion({ topics }) {
  ...
  return (
    <div className="flex flex-col bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl p-4 space-y-4 w-full text-center shadow-lg shadow-blue-500/50 hover:shadow-lg hover:shadow-purple-900/50">
      <h2
        className="text-5xl font-bold font-serif cursor-pointer text-neutral-200 hover:text-neutral-300 shadow-lg shadow-purple-400/50 bg-gradient-to-r from-purple-600 to-blue-600 p-2 rounded-t-lg"
        ...
        <div className="space-y-2 flex flex-col">
          ...
          <div className="flex flex-col gap-4">
            {topics.map((topic, index) => (
              ...
              >
                <div className="bg-gradient-to-r from-blue-900 to-black bg-clip-text hover:bg-clip-text text-transparent p-4 rounded-xl">
